...
- create otp - cleaner offline app
- have one small llm model or use which is shipped with the android by default
- have it totally as an offline app
- it read sms offline and prvides suggestion to delete the otp texts
- they can schedule when to check for the otp messages during night time it will be less load on the system
