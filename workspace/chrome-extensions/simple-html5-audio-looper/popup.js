...
async function loadFile(file) {
  ...
  reader.onload = async (e) => {
    ...
    // Persist settings
    chrome.storage.local.set({ lastFileName: file.name, loop: isLooping, volume: volumeSlider.value, speed: speedSelect.value });
  };
...
chrome.storage.local.get(['lastFileName', 'loop', 'volume', 'speed'], (data) => {
